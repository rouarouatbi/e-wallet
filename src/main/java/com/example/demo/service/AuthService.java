...
import com.example.demo.config.Validators;
...
public class AuthService {
    ...
    public void signup(RegisterRequest registerRequest) throws SpringException{
        if (!validators.emailValidator(registerRequest.getEmail())) {
        ...
        if (!validators.usernameValidator(registerRequest.getUsername())) {
            throw new SpringException(
                    "Username Invalid. It must be of length ranging(3-30) and no Special Characters. "
                            +"starting letter should be a number or a character. "
                            +"Example : username1");
